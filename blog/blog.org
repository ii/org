...
containers:
          - image: gcr.io/k8s-testimages/image-builder:v20210302-aa40187
            ...
            args:
              ...
              - apps/snoopdb
#+END_SRC
Postsubmit example at the bottom
...
This file contains the images to tag mapping
https://github.com/kubernetes/k8s.io/blob/main/k8s.gcr.io/images/k8s-staging-apisnoop/images.yaml
**** Some information om image promotion process
https://github.com/kubernetes/k8s.io/tree/main/k8s.gcr.io#readme
Trying not to repeat here is my tldr;
- Our project has a s

  * Idee is om hier te verduidelik hoe ons die dokument se stappe hier onder toepas om ons image gebou te kry, noggal nifty
  * Hoop om vanaand na aand ete vir paar ure te kom sit en werk, laat weet my hoe dit vir jou uitwerk
**** Information on how our tags are used
https://github.com/kubernetes/k8s.io/tree/main/k8s.gcr.io#readme
