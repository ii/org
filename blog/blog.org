...
:PROPERTIES:
:EXPORT_FILE_NAME: how-ii-makes-apisnoop-releases
:EXPORT_DATE: 2021-04-22
:EXPORT_HUGO_CUSTOM_FRONT_MATTER: :summary "Document with intent on knowledge share: The process APISnoop goes through to build images and understanding tags role"
:EXPORT_AUTHOR: Berno Kleinhans
:END:
*** This is how ii makes apisnoop releases
*** Starting repo and the tags we have:
https://github.com/cncf/apisnoop/tags
*** Overview of image publish jobs and how we can use them to promote our images: [[https://github.com/kubernetes/test-infra/blob/master/config/jobs/image-pushing/README.md#image-pushing-jobs][test-infra-config/jobs/image-pushing/README]]
https://github.com/kubernetes/test-infra/blob/master/config/jobs/image-pushing/README.md#image-pushing-jobs
- We set up a [[https://github.com/kubernetes/k8s.io/blob/main/k8s.gcr.io/README.md#managing-kubernetes-container-registries][GCR]] to build our images in (https://github.com/kubernetes/k8s.io/blob/main/k8s.gcr.io/README.md#managing-kubernetes-container-registries)
- We set up a image promoter [[https://github.com/kubernetes/k8s.io/blob/main/k8s.gcr.io/README.md#image-promoter][promoter]]  (https://github.com/kubernetes/k8s.io/blob/main/k8s.gcr.io/README.md#image-promoter)
*** Prow definition of image-build for apisnoop:
Use the [[https://github.com/kubernetes/test-infra/blob/master/config/jobs/image-pushing/README.md][documentation]]
The use of this template is very restricted [[https://github.com/kubernetes/test-infra/blob/master/config/jobs/image-pushing/README.md#prow-config-template][prow-config-template]]  (https://github.com/kubernetes/test-infra/blob/master/config/jobs/image-pushing/README.md#prow-config-template)

These are postsubmit jobs we defined [[https://github.com/kubernetes/test-infra/blob/master/config/jobs/image-pushing/k8s-staging-apisnoop.yaml][test-infra/config/jobs/image/pushing/k8s-staging-apisnoop.yaml]]
...
This file contains the image metadata [[https://github.com/kubernetes/k8s.io/blob/main/k8s.gcr.io/images/k8s-staging-apisnoop/images.yaml][k8s.io/k8s.gcr.io/images/k8s-staging-apisnoop/images.yaml]]
