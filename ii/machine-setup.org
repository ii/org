...
[github]
	user = hh
[commit]
	template = /home/hippie/.config/COMMIT_EDITMSG.co-authored
EOF
#+END_SRC

#+NAME: ~/.config/COMMIT_EDITMSG.co-authored
#+BEGIN_SRC text
...
# Co-Authored-By: Josmar Hart <jay@ii.coop>
# Co-Authored-By: Brenda Peel <brenda@ii.coop>
# Co-Authored-By: David Bollen <david@ii.coop>
#+END_SRC
